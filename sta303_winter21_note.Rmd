...
If you're reading this, you may have been directed to this link by a former student of mine to provide you with more information about the project they completed in my course. This page doesn't have student specific information, but should give you a sense of the kinds of skills students who completed this project successfully will have. You may wish to [skip directly to the skills description](#skills).

***The project in one sentence:** Students merged, wrangled, visualized, summarized and modelled data on hiring, salary and promotion to meet a client brief, and reported on their methods and findings appropriately for a general executive audience and, separately, for a technical audience.*
...
Each team or individual created a consulting company name, for the purposes of this activity and to register their group/individual status completed a pseudo-NDA, of which the only real part was reminding them that they had already agreed to several codes of conduct as part of their enrolment at U of T and made clear my expectations of their professionalism.
...
They were tasked to answer the research questions posed by the client, communicate their findings in ways appropriate to the audience for each section of the report, choose appropriate methods and create professional visualizations and tables to explain their results.
