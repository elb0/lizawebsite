...
## Industry _then_ grad school? How to ask about references for a few years from now
...
So firstly, the 'two activity criterion' (from above) still applies, but you don't need to fill out the form _now_. 

#### What you should do _now_:

- IFF (if and only if) you meet my criteria, let me know that this is what you're considering. Do it via __email__ so a few years from now when you ask and I search your name, I'll have a record of the conversation.  
...
#### What you should do when you're _planning to apply_:
